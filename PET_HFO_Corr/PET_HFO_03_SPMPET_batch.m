...
%% Parameters
ResultsFolder     = 'E:\13.2.Zilin_HFO_anat_rPET\2.SPM_PET_Results';
CalcFolder        = 'D:\10SPMPET\Patients';
tempResultsFolder = 'D:\10SPMPET\Results';
% load the Age and Gender info
% Age in years
AgeList = textread('E:\13.2.Zilin_HFO_anat_rPET\subAge.txt');
% Set patient gender: female = 1; male = 0;
GenderList = textread('E:\13.2.Zilin_HFO_anat_rPET\subGender.txt');
%% Subject loop
cd('E:\13.2.Zilin_HFO_anat_rPET\1.subRAW')
subDir = dir();
subDir = subDir(3:end);
